...
public class Room {
	 ...
	 * not used
	 */
	private Boolean seerPower = false; // seer = voyante ; // gerer si la voyante a utilis� son pouvoir
	/**
	 * not used
	 */
	private Boolean witchPower = false; // witch = sorciere ; // gerer si la sorci�re a utilis� son pouvoir
