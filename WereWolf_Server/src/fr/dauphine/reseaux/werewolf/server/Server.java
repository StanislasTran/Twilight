...
public class Server {
	...
	private static final String DEBUT_DU_JEU = "Bienvenue sur le jeu du Loup-Garou! Le jeu peut commencer. Nous entrons dans une nuit noire à Thiercelieux, les villageois dorment profondemment ...\n\n"
			+ "-------------------------------------------------------\n";
	...
	public void START_GAME() throws InterruptedException {
		try {
			...
			while (!gameFinished()) {
				...
				sendToAll("@Narrator;" + "Le jour se lève: " + eliminatedPlayer + " est mort :( !");
			}
